...
!--- local variables ---
    ...
    integer :: isc, iec, jsc, jec, npz , nq ,ng !uanber added nq, ng
    integer :: is, ie, js, je
...
!--- indices for one-based arrays
       ...
       js = jsw-jsc+1
       je = jew-jsc+1
       call physics_driver_down ( is, ie, js, je, npz,nq, ng, Time_prev, Atmos%Time, Time_next, &  !uanber added nq, ng
                                  Atmos%lat   (is:ie,js:je),   &
                                  Atmos%lon   (is:ie,js:je),   &
...
!--- local variables ---
    ...
    integer :: sec, day
    integer :: isw, iew, jsw, jew ! block start/end in global index space (just indices)
    integer :: isc, iec, jsc, jec, npz !uanber: added nq, ng
    integer :: is, ie, js, je
    integer :: blk
...
!--- indices for one-based arrays
       ...
       js = jsw-jsc+1
       je = jew-jsc+1
       call physics_driver_up ( is, ie, js, je, npz, &      !uanber: added nq, ng
